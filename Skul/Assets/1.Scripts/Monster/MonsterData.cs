...
public class MonsterData : ScriptableObject
{
    ...
    [SerializeField] 
    private int monsterHp;                                              // 현재체력
    public int MonsterHp { get { return monsterHp; } }

    [SerializeField] 
    private int monsterMaxHp;                                           // 최대체력
    ...
    [SerializeField] 
    private float sightRangeX;                                          // X축 시야범위
    public float SightRangeX { get { return sightRangeX; } }
    
    [SerializeField] 
    private float sightRangeY;                                          // y축 시야범위
    ...
    [SerializeField] 
    private bool hasAdditionalAttack;                                   // 스킬보유여부
